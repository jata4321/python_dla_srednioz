...
class PromoCake(Cake, Promo):
    def __init__(self, cake_, promo):
        Cake.__init__(self, cake_.name, cake_.kind, cake_.taste, cake_.additives, cake_.filling)
...
promo11 = PromoCake(cake, promo10)

promo11.show_info()
print(promo11.full_name)
